...
class ShoppingCart {
    ...
    public static void main(String[] args) {
        shoppingCart.add(new Book("Delikatne uderzenie pioruna", 99.99f, 0.8f,1.05f));
        shoppingCart.add(new Book("Wiedzmin", 29.99f, 1.08f, 1.05f));
    ...
    private static void calculateWeight(List<Element> shoppingCart) {
        ...
        System.out.println(
                String.format("Total weight: %.2f",
                getValue(shoppingCart, visitor))
        );
    }
